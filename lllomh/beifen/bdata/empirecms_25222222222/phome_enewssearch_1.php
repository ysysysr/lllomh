...
E_D("replace into `phome_enewssearch` values('1','大自然','1431741185','title','1','192.168.1.1','','7','newstime','0','971c1b39003e46e48d73b0a916e8ae55','news','1','0',' and ((title LIKE ''%大自然%''))','0');");
...
E_D("replace into `phome_enewssearch` values('14','小工具','1418260667','title','1','192.168.1.1','','1','newstime','0','e34d1433187e854a0e5aad98b0a8b0aa','news','1','0',' and ((title LIKE ''%小工具%''))','0');");
...
E_D("replace into `phome_enewssearch` values('18','棉花糖','1419427840','title','1','121.22.249.200','','1','newstime','0','054c1dda4ce8d9be808692ff8269793f','news','1','0',' and ((title LIKE ''%棉花糖%''))','0');");
...
E_D("replace into `phome_enewssearch` values('30','幼儿园','1425544007','title','1','27.154.249.230','','2','newstime','0','a4141a22f04af6f552defab29e94ddaf','news','1','0',' and ((title LIKE ''%幼儿园%''))','0');");
...
E_D("replace into `phome_enewssearch` values('36','点','1432537365','title','1','183.191.240.148','','1','newstime','0','3b5090c5b148702900ba1a0d7f2114d3','news','1','0',' and ((title LIKE ''%点%''))','0');");
E_D("replace into `phome_enewssearch` values('37','的','1444787297','title','48','127.0.0.1','','1','newstime','0','df8cfc447487db36a983362af553a345','news','1','0',' and ((title LIKE ''%的%''))','0');");
