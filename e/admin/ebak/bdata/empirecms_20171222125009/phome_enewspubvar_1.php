...
E_D("replace into `phome_enewspubvar` values('3','icp','备案信息','鲁ICP�\�12345678�\�','填入你的备案信息','0','0','1');");
...
E_D("replace into `phome_enewspubvar` values('7','duoshuo','多说2级域�\�','ecms009','这里填写你申请的多说代码的二级域�\�','0','0','1');");
