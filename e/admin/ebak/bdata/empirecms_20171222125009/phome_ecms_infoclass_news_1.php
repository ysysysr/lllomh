...
E_C("CREATE TABLE `phome_ecms_infoclass_news` (
  ...
  `zz_onetext` text NOT NULL,
  `z_onetext` varchar(255) NOT NULL,
  `qz_onetext` varchar(255) NOT NULL,
  `save_onetext` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
E_D("replace into `phome_ecms_infoclass_news` values('2','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','');");
