...
<head>
    ...
    <meta name="keywords" content="[!--pagekey--],芈渡,lllomh,海波" />
    <meta name="description" content="[!--pagedes--],芈渡,lllomh,海波 " />
    <title>芈渡,lllomh</title>
...
<section class="container">
    <div class="content-wrap">
        <div class="content excerpts"><h3 class="title"><small class="pull-right">24小时发布文字<span id="tp"></span></small> </h3>
...
<script>
    ...
    document.getElementById("tp").innerHTML=po;
    var jsui={
        uri: '/skin/ecms009'
    };
</script>
