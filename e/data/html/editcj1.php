...
</td></tr><tr><td bgcolor=ffffff>一句话文本</td><td bgcolor=ffffff><input name="onetext" type="text" id="onetext" value="<?=$ecmsfirstpost==1?"感觉不错，很赞哦！":ehtmlspecialchars(stripSlashes($r[onetext]))?>" size="60">
